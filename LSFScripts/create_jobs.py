...
JobParams = {
	'CreateHash': {
		...
		'body': ["""python """+LSA_dir+"""/create_hash.py -i PROJECT_HOME/original_reads/ -o PROJECT_HOME/hashed_reads/ -k 33 -s 31"""]},
	'HashReads': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python """+LSA_dir+"""/hash_fastq_reads.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/original_reads/ -o PROJECT_HOME/hashed_reads/"""]},
	'MergeHash': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python """+LSA_dir+"""/merge_hashq_files.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/hashed_reads/"""]},
	'CombineFractions': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python """+LSA_dir+"""/merge_hashq_fractions.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/hashed_reads/"""]},
	'GlobalWeights': {
		...
		'body': ["""python """+LSA_dir+"""/tfidf_corpus.py -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/cluster_vectors/"""]},
	'KmerCorpus': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python """+LSA_dir+"""/kmer_corpus.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/cluster_vectors/"""]},
	'KmerLSI': {
		...
		'body': ["""python """+LSA_dir+"""/kmer_lsi.py -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/cluster_vectors/""","""kill $P1 $P2 $P3 $P4 $P5 $P6 $P7"""]},
	'KmerClusterIndex': {
		...
		'body': ["""python """+LSA_dir+"""/kmer_cluster_index.py -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/cluster_vectors/ -t 0.7""","""python """+LSFScripts_dir+"""/create_jobs.py -j KmerClusterParts -i ./""","""X=`sed -n 1p hashed_reads/hashParts.txt`""","""sed -i 's/%parts%/$X/g' """+LSFScripts_dir+"""/KmerClusterParts_ArrayJob.q""","""python """+LSFScripts_dir+"""/create_jobs.py -j """+LSFScripts_dir+"""/KmerClusterMerge -i ./""","""X=`sed -n 1p cluster_vectors/numClusters.txt`""","""sed -i 's/%clusters%/$X/g' """+LSFScripts_dir+"""/KmerClusterMerge_ArrayJob.q"""]},
	'KmerClusterParts': {
		...
		###!!!
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python """+LSA_dir+"""/kmer_cluster_part.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/cluster_vectors/ -t 0.7"""]},
	'KmerClusterMerge': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python """+LSA_dir+"""/kmer_cluster_merge.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/cluster_vectors/ -o PROJECT_HOME/cluster_vectors/"""]},
	'KmerClusterCols': {
		...
		'body': ["""python """+LSA_dir+"""/kmer_cluster_cols.py -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/cluster_vectors/"""]},
	'ReadPartitions': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python """+LSA_dir+"""/write_partition_parts.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/hashed_reads/ -o PROJECT_HOME/cluster_vectors/ -t TMPDIR"""]},
	'MergeIntermediatePartitions': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python """+LSA_dir+"""/merge_partition_parts.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/cluster_vectors/ -o PROJECT_HOME/read_partitions/"""]},
	...
	'SplitPairs': {
		...
		'body': ["""sleep $(($LSB_JOBINDEX % 60))""","""python """+LSA_dir+"""/split_read_pairs.py -r ${LSB_JOBINDEX} -i PROJECT_HOME/read_partitions/ -o PROJECT_HOME/read_partitions/"""]},
	'PhylerClassify': {
...
if __name__ == "__main__":
	...
	f = open(inputdir+LSFScripts_dir+'/'+params['outfile'],'w')
